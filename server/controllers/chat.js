...
const addMembers=TryCatch(async(req,res,next)=>{
    ...
    emitEvent(
        ...
        ALERT,
        chat.members,
        `${allUserName} has been added into the group`
    );
...
const leaveGroup=TryCatch(async(req,res,next)=>{
 ...
 const deleteChat=TryCatch(async (req,res,next)=>{
    ...
    if(chat.groupChat && chat.creator.toString()!==req.user.toString())  return next(new ErrorHandler("You are not allowed to delete the group",400));
